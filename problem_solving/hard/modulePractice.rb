...
# have one class method called makeSound(). All these methods can simply
# print some strings; the focus here is to structure the module correctly.
# Once your module is done, write to classes Car and Motorcycle that include
# the Driveable module. The module has to be structured in a way that your
# class will have the instance and class methods available, i.e. you should
